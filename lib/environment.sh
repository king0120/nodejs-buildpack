create_default_env() {
  ...
  export LD_LIBRARY_PATH="/home/vcap/app/node/instantclientbasic"
  export OCI_LIB_DIR="/home/vcap/app/node/instantclientbasic"
  export OCI_INC_DIR="/home/vcap/app/node/instantclientbasic/sdk/include"
}
