create_default_env() {
  ...
  export LD_LIBRARY_PATH="/home/vcap/app2/node/instantclientbasic"
  export OCI_LIB_DIR="/home/vcap/app2/node/instantclientbasic"
  export OCI_INC_DIR="/home/vcap/app2/node/instantclientbasic/sdk/include"
}
